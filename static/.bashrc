...
eyamledit () {
  sudo eyaml edit --pkcs7-private-key=/usr/local/etc/puppet/eyaml/private_key.pkcs7.pem --pkcs7-public-key=/usr/local/etc/puppet/eyaml/public_key.pkcs7.pem $1
}
...
alias root="sudo -i"
if [[ `hostname` == "mn-hc-bpuppetserver-t1.honeycomb.net" ]] ; then
